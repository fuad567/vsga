...
<html lang="en">
  <head>
    ...
    <title>Tambah Data - Aplikasi Mahasiswa - Digital Talent</title>
  </head>
  <body style="background-color:#c2c2d6">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active" style="background-color:#00004d;color:white;padding-top:10px;margin-top:-10px;margin-bottom:-10px;padding-left:10px;padding-right:10px">
              <a class="nav-link" href="latihanhari12-tambahdata.php">Tambah Data <span class="sr-only">(current)</span></a>
            </li>
    ...
    <div class="container" style="padding-bottom: 100px">
      <h2 style="text-align:center;padding-top:20px;padding-bottom: 20px">Tambah Data Mahasiswa</h2>

      <form class="form-group" action="latihanhari12-action.php" method="post">
        <div class="row shadowb" style="padding-top:25px;padding-bottom: 35px;background-color:#7575a3;color:white">
          <div class="col-md-6" style="padding-left:25px;padding-right:25px">
            <label>NIM</label> <input type="text" name="nim" class="form-control" placeholder="Masukkan NIM" required><br />
            ...
            <label>Jenis Kelamin</label> <select name="kelamin" class="form-control" required>
                                  ...
                                  <option value="P">Perempuan</option></select><br />
          </div>
          <div class="col-md-6" style="padding-left:25px;padding-right:25px">
            <label>Jurusan</label> <input type="text" name="jurusan" class="form-control" placeholder="Masukkan Jurusan" required><br />
