...
<html lang="en">
  <head>
    ...
    <title>Data Siswa Pendaftar - Aplikasi Pendaftaran Siswa - Digital Talent</title>
  </head>
  <body style="background-color:#c2c2d6">
    <div class="container-fluid shadowb" style="padding:0px">
      <nav class="navbar navbar-expand-lg navbar-dark" style="background:linear-gradient(to right, #006699 0%, #000066 100%)!important">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <form class="form-inline my-0 my-lg-0" action="data_pendaftar.php" method="get">
    ...
    <div class="container" style="padding-bottom: 100px">
      ...
      <table class="table shadowb" style="border-bottom:1px solid #dee2e6;border-left:1px solid #dee2e6;border-right:1px solid #dee2e6;">
        <thead>
          <tr class="text-light" style="text-align:center;background:linear-gradient(to right, #006699 0%, #000066 100%)">
            ...
            <th style="border-left:1px solid #dee2e6;border-right:1px solid #dee2e6;">ID Pendaftar</th>
            ...
            <th style="border-left:1px solid #dee2e6;border-right:1px solid #dee2e6;">Agama</th>
            <th style="border-left:1px solid #dee2e6;border-right:1px solid #dee2e6;">Asal Sekolah</th>
        ...
        <tbody>
          <?php
            ...
            if(!isset($_GET['cari'])) {
              $mahasiswa = mysqli_query($db, "SELECT * FROM pendaftaran");
            }
            else {
              $keyword = $_GET['cari'];
              $mahasiswa = mysqli_query($db, "SELECT * FROM pendaftaran WHERE id_pendaftar LIKE '%$keyword' OR nama LIKE '%$keyword%' OR agama LIKE '%$keyword%' OR asal_sekolah LIKE '%$keyword%' OR jenis_kelamin LIKE '%$keyword%'");
            }
          ...
          <tr>
            ...
            <td style='border-left:1px solid #dee2e6;border-right:1px solid #dee2e6;'>".$row['no_pendaftaran']."</td>
            ...
            <td style='border-left:1px solid #dee2e6;border-right:1px solid #dee2e6;'>".$row['agama']."</td>
            <td style='border-left:1px solid #dee2e6;border-right:1px solid #dee2e6;'>".$row['asal_sekolah']."</td>
            <td style='border-left:1px solid #dee2e6;border-right:1px solid #dee2e6;'>".$row['alamat']."</td>
            <td style='border-left:1px solid #dee2e6;border-right:1px solid #dee2e6;text-align: center;'><a href='hapus.php?id=".$row['id_pendaftar']."'><i class='fa fa-trash' aria-hidden='true'></i></a> &nbsp;
                <a href='edit_pendaftar.php?id=".$row['id_pendaftar']."'><i class='fa fa-pencil' aria-hidden='true'></i></a></td>
          </tr>";
              $no++;
            }
          ?>
      ...
      <?php
        echo 'Total Siswa Terdaftar : <b>'. mysqli_num_rows($mahasiswa).'</b>';
