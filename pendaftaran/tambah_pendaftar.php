...
<html lang="en">
  <head>
    ...
    <title>Tambah Siswa Pendaftar - Aplikasi Pendaftaran Siswa - Digital Talent</title>
  </head>
  <body style="background-color:#c2c2d6">
    ...
    <div class="container" style="padding-bottom: 100px">
      <h2 style="text-align:center;padding-top:20px;padding-bottom: 20px">Formulir Pendaftaran Siswa Baru</h2>

      <form class="form-group" action="tambah.php" method="post">
        <div class="row shadowb" style="padding-top:25px;padding-bottom: 35px;background-color:#7575a3;color:white">
          <div class="col-md-6" style="padding-left:25px;padding-right:25px">
            ...
            <label>Agama</label> <select name="agama" class="form-control" required>
                                  ...
                                  <option value="Kantholik">Kantholik</option>
                                  <option value="Budha">Budha</option></select>
                                  <br />
          </div>
          <div class="col-md-6" style="padding-left:25px;padding-right:25px">
            <label>Asal</label> <input type="text" name="asal_sekolah" class="form-control" placeholder="Masukkan Asal Sekolah" required><br />
